<template>
    ...
    <div class="mb-6 flex items-center justify-between">
        <div class="flex items-center space-x-6">
            <img :src="post.created_by.avatar_url" class="w-[40px] rounded-full">
    ...
    <template v-if="post.attachments.length">
        <img v-for="image in post.attachments" v-bind:key="image.id" :src="image.image_url"
    ...
    <div class="my-6 flex justify-between">
        <div class="flex space-x-6 item-center">
            <div @click="likePost" class="flex items-center space-x-2">
            ...
            <div class="flex items-center space-x-2">
                ...
                <RouterLink :to="{ name: 'postdetail', params: { id: post.id } }" class="text-gray-500 text-xs">
    ...
    <div v-if="showMenu">
        <div class="flex space-x-6 item-center">
            <div v-if="userStore.user.id == post.created_by.id" class="flex items-center space-x-2" @click="deletePost">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            ...
            <div v-if="userStore.user.id != post.created_by.id" class="flex items-center space-x-2" @click="reportPost">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
